...
public class AppController {
	...
	Student s1 = new Student("2020ICT20","Maleesha",23,"ICT",3.66);
	Student s2 = new Student("2020CS12","Ruwini",24,"CS",3.80);
	Student s3 = new Student("2020ASB43","Nimna",23,"BIO Sceince",4.0);
